#include <iostream>
#include<Eigen/Dense> //download eigen template library from : https://eigen.tuxfamily.org/index.php?title=Main_Page
...
int main()
{
	// define 3x3 matrix of floats and set its entries to zero
